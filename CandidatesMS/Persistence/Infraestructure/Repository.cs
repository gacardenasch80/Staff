...
namespace CandidatesMS.Persistence.Infraestructure
{
    ...
    {
        protected readonly CandidateContext _context;

        protected readonly CompanyContext _contextCompany;
        ...
        public Repository(CandidateContext context, CompanyContext contextCompany)
        {
            _context = context;
