...
{
    public partial class RemoteMail6Migration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "AttachedFileRemoteMail",
                columns: table => new
                {
                    AttachedFileRemoteMailId = table.Column<int>(nullable: false)
                    ...
                    RemoteMailId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AttachedFileRemoteMail", x => x.AttachedFileRemoteMailId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttachedFileRemoteMail_RemoteMailId",
